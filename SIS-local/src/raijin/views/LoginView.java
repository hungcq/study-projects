...
import raijin.controllers.LoginResult;
...
public class LoginView extends JDialog {
    ...
    private JLabel wrongLoginInfo;
    private ControllerInterface c1;

    public LoginView(ControllerInterface controllerInterface) {
        c1 = controllerInterface;
    ...
    private void onOK() {
        ...
        if (nameField.getText().isEmpty() || passwordField.getText().isEmpty()) {
            wrongLoginInfo.setText("Fill in the blank");
            wrongLoginInfo.setVisible(true);
            return;
        } else {
            LoginResult l = c1.login(nameField.getText(), passwordField.getText());
            if (l == LoginResult.LOGIN_FAIL) {
                wrongLoginInfo.setText("Login Fail");
                wrongLoginInfo.setVisible(true);
            } else if (l == LoginResult.TYPE_MANAGER) {
                DataManager.setCurrentUser(DataManager.getInst().findManagerByID(nameField.getText()));
                MStudentList mhome = new MStudentList(c1);
                mhome.pack();
                mhome.setLocationRelativeTo(null);
                dispose();
                mhome.setVisible(true);
            } else {
                DataManager.setCurrentUser(DataManager.getInst().findStudentByID(nameField.getText()));
                SMyCourses shome = new SMyCourses(c1);
                shome.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.setBorder(BorderFactory.createTitledBorder(null, "SMS ver 1.0", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.BELOW_TOP));
        ...
        panel3.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(3, 1, new Insets(5, 0, 5, 0), -1, -1));
        ...
        LoginTextArea = new JLabel();
        LoginTextArea.setFont(new Font(LoginTextArea.getFont().getName(), Font.BOLD, LoginTextArea.getFont().getSize()));
        LoginTextArea.setText("Student Management System Login");
        panel3.add(LoginTextArea, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel5.add(passwordField, new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        wrongLoginInfo = new JLabel();
        wrongLoginInfo.setText("");
        wrongLoginInfo.setVisible(false);
        contentPane.add(wrongLoginInfo, new com.intellij.uiDesigner.core.GridConstraints(0, 0, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
