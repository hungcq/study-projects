...
public class MManagerList extends JDialog {
    ...
    private void onAdd() {
        // add your code here
        MAddManager mView = new MAddManager();
        mView.pack();
    ...
    private void createUIComponents() {
        ...
        for (Manager manager : DataManager.getInst().getManagerList()) {
            tmd.addRow(new Object[]{manager.getId(), manager.getName(), manager.getDateOfBirth(), manager.getPhoneNumber()});
        }
