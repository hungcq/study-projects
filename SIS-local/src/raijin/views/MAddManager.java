...
public class MAddManager extends JDialog {
    ...
    private void onOK() {
        ...
        Manager newManager = new Manager(idField.getText(), nameField.getText(), passwordField.getText(), dobField.getText(), phoneNoField.getText());
        DataManager.getInst().addManager(newManager);
        MManagerList.tmd.setRowCount(0);
        for (Manager manager : DataManager.getInst().getManagerList()) {
            MManagerList.tmd.addRow(new Object[]{manager.getId(), manager.getName(), manager.getDateOfBirth(), manager.getPhoneNumber()});
        }
        dispose();
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(dobField, new com.intellij.uiDesigner.core.GridConstraints(3, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel3.add(passwordField, new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JLabel label6 = new JLabel();
        label6.setText("Add Manager");
