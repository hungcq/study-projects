...
public class PlaneController extends SingleControllerWithHP implements Colliable {
    ...
    public void run() {
        if(this.gameObject.isAlive()) {
            Rectangle rectNext   = this.gameObject.getNextRect(this.gameVector);
            if(GameConfig.getInst().isInScreen(rectNext)) {
                super.run();
    ...
    public void onCollide(Colliable c) {
        ...
        } else if (c instanceof EnemyBulletController || c instanceof EnemyBulletController2) {
