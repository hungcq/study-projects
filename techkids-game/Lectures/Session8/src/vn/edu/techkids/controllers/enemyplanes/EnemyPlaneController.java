...
//                        new ImageDrawer("resources/enemy_plane_white_1.png");
            ...
            case YELLOW:
                AnimationDrawer yellowPlaneDrawer = new AnimationDrawer (
                        Utils.loadSpriteSheet("resources/enemy_plane_yellow.png", 3, 1, 1, 32, 32));
                DeadAnimationDrawer deadAnimationDrawer = new DeadAnimationDrawer(
                        Utils.loadSpriteSheet("resources/explosion.png", 6, 1, 1, 32, 32));

                gameVector = new GameVector(0, 2);
                enemyPlaneController = new EnemyPlaneController(enemyPlane,
                        new EnemyPlaneDrawer(yellowPlaneDrawer, deadAnimationDrawer),
                        gameVector);
                break;
        }
