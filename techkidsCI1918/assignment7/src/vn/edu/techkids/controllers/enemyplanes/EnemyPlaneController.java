...
//        this.enemyBulletControllerManager.paint(g);
    ...
    public static EnemyPlaneController create(EnemyPlaneType enemyPlaneType,
        ...
        switch (enemyPlaneType){
            case BLACK:
                enemyPlane = new EnemyPlane(x,y,EnemyPlane.WIDTH_DEFAULT, EnemyPlane.HEIGHT_DEFAULT);
            ...
            case WHITE:
                ...
                enemyPlaneController = new EnemyPlaneController(enemyPlane, whitePlaneDrawer, gameVector, new EnemyBiasShotBehavior());
                break;
            case YELLOW:
                enemyPlane = new EnemyPlane(x,y,EnemyPlane.WIDTH_DEFAULT, EnemyPlane.HEIGHT_DEFAULT, 2);
                ...
                gameVector = new GameVector(0,2);
                enemyPlaneController = new EnemyPlaneController(enemyPlane, yellowPlaneDrawer, gameVector, new EnemySlowShotBehavior());
        }
