...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            $currMonthCell.data('navigation', 'currMonth');
            $currMonthCell.data('value', { "year": year, "month": month });
            $currMonthCell.append($currMonthLabel);
            
            if (typeof($calendarElement.data('actionNavFunction')) === 'function') {
            	$currMonthCell.click($calendarElement.data('actionNavFunction'));
            }
        ...
        function drawEvents($calendarElement, type) {
            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    if (typeof(value.cardNums) !== 'undefined') {
                        $dowElement.attr('data-card-nums', value.cardNums);
                        if(value.cardNums > 0){
                        	$dowElement.append($('<span class="card-nums">'+value.cardNums+'</span>'));
                        }
                    }
                    
                    if (typeof(value.cardNumsStudied) !== 'undefined') {
                        $dowElement.attr('data-card-nums-studied', value.cardNumsStudied);
                        if(value.cardNumsStudied > 0){
                        	$dowElement.append($('<span class="card-nums-studied">'+value.cardNumsStudied+'</span>'));
                        }
                    }
