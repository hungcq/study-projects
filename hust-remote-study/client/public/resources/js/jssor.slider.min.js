(function(k, f, c, j, d, l, g) {/* ! Jssor */
	...
	var b = k.$Jssor$ = new function() {
		...
		function ab(a) {
			a.constructor === ab.caller && a.$Construct
					&& a.$Construct.apply(a, ab.caller.arguments)
		}
		h.$Construct = ab;
		...
		h.$SetStyleClip = function(d, a) {
			if (a)
				d.style.clip = "rect(" + c.round(a.$Top || a.$MoveY || 0)
						+ "px " + c.round(a.$Right) + "px "
						+ c.round(a.$Bottom) + "px "
						+ c.round(a.$Left || a.$MoveX || 0) + "px)";
			else if (a !== g) {
		...
		h.$Cast = function(l, m, x, q, z, A, n) {
			...
			if (m.$Clip && n.$Move) {
				var o = a.$Clip.$Offset, s = (o.$Top || 0) + (o.$Bottom || 0), r = (o.$Left || 0)
						+ (o.$Right || 0);
				a.$Left = (a.$Left || 0) + r;
				a.$Top = (a.$Top || 0) + s;
				a.$Clip.$Left -= r;
	...
	k.$JssorSlideshowRunner$ = function(k, s, q, u, z) {
		...
		if (b.$IsBrowserIe9Earlier() || b.$IsBrowserOpera() || z
				&& b.$WebKitVersion() < 537)
			h = 16;
		n.call(f);
		m.call(f, -1e7, 1e7)
	...
	var i = k.$JssorSlider$ = function(p, hc) {
		...
		function zc(y, f, p, q) {
			...
			a.$OpenSlideshowPanel = function(a) {
				p
						&& b.$CssOverflow(ib, a && p.$Transition.$Outside ? ""
								: "hidden")
			};
		...
		var hb = a.$PlayOrientation & 3, xc = (a.$PlayOrientation & 4) / -4
				|| 1, eb = a.$SlideshowOptions, I = b.$Extend({
			$Class : q,
			$PlayInMode : 1,
			$PlayOutMode : 1,
			$HWA : a.$HWA
		...
		var s = -1, yb, ub, r = T.length, K = a.$SlideWidth || pc, J = a.$SlideHeight
				|| oc, Yb = a.$SlideSpacing, Bb = K + Yb, Cb = J + Yb, dc = hb & 1 ? Bb
				: Cb, u = c.min(a.$Cols, r), ib, x, L, Ab, S = [], Sb, Ub, Qb, fc, Gc, P, E = a.$PauseOnHover, qc = a.$AutoPlayInterval, Xb = a.$SlideDuration, sb, db, gb, Tb = u < r, D = Tb ? a.$Loop
				: 0, Y, M, F = 1, O, B, R, vb = 0, wb = 0, H, bb, fb, Eb, w, U, z, Vb = new sc, Z, Nb = [];
		if (r) {
			if (a.$HWA)
				Mb = function(a, c, d) {
	...
	k.$JssorCaptionSlideo$ = function(n, f, l) {
		...
		function r(e, f, a) {
			b.$Each(f,
					function(h) {
						var f = b.$Extend(d, {}, j(h)), g = b
								.$FormatEasings(f.$Easing);
						delete f.$Easing;
						if (f.$Left) {
							f.$MoveX = f.$Left;
							g.$MoveX = g.$Left;
